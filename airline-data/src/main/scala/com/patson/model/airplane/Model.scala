...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Antonov An24", "Antonov-A", capacity = 44, fuelBurn = (44 * 2.0).toInt, speed = 450, range = 2400, price = 135000000, lifespan = 25 * 52, constructionTime = 0, Manufacturer("Antonov", countryCode = "UA"), runwayRequirement = 1650),
    ...
    Model("Ilyushin Il-114-100", "Ilyushin Il-114", capacity = 64, fuelBurn = (64 * 2.8).toInt, speed = 470, range = 1000, price = 14000000, lifespan = 25 * 52, constructionTime = 4, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 750),
    Model("Ilyushin Il-114-300", "Ilyushin Il-114", capacity = 64, fuelBurn = (64 * 2.6).toInt, speed = 470, range = 5000, price = 20000000, lifespan = 25 * 52, constructionTime = 4, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 750),
    ...
    Model("Sukhoi Superjet 100 NEW", "Sukhoi Superjet", capacity = 108, fuelBurn = (108 * 4.2).toInt, speed = 815, range = 4400, price = 35600000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("JSC Sukhoi", countryCode = "RU"), runwayRequirement = 1770, imageUrl = "https://www.norebbo.com/2016/02/sukhoi-ssj-100-blank-illustration-templates/"),
    Model("Sukhoi Superjet 100 Original", "Sukhoi Superjet", capacity = 108, fuelBurn = (108 * 4.0).toInt, speed = 828, range = 4578, price = 38000000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("JSC Sukhoi", countryCode = "RU"), runwayRequirement = 1731, imageUrl = "https://www.norebbo.com/2016/02/sukhoi-ssj-100-blank-illustration-templates/"),
    ...
    Model("Ilyushin 96-400M", "Ilyushin Il-96", capacity = 390, fuelBurn = (390 * 5.5).toInt, speed = 870, range = 11500, price = 135000000, lifespan = 25 * 52, constructionTime = 36, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2500),
